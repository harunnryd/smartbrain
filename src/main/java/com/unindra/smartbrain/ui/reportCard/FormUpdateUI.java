...
public class FormUpdateUI extends JFrame {
     ...
     * Creates new form FormUI
     */
    public FormUpdateUI(String reportCardId, String instructorName, String participantName, String courseName, String score, String schoolYear) {
        initComponents();
        initComboBox();
        
        this.reportCardId = Integer.parseInt(reportCardId);
        instructorComboBox.setSelectedItem(instructorName);
        participantComboBox.setSelectedItem(participantName);
    ...
    private void updateButtonMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_updateButtonMousePressed
        ...
        reportCardRepo.updateReportCardById(this.reportCardId, new ReportCard(
