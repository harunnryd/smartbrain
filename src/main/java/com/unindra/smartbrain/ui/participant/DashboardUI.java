 ...
 */
package com.unindra.smartbrain.ui.participant;
...
public class DashboardUI extends JFrame {
    ...
    public void initTableParticipant() {
        participantPageButton.setEnabled(false);
        ...
        IfaceParticipantRepository repo = new ParticipantRepository(entityManager);
        List<Participant> participants = repo.getParticipants();
        
        for (Participant participant : participants) {
            tableModel.addRow(new Object[]{participant.getId(), participant.getName(), participant.getAge(), participant.getAddress()});
        }
        
        tableParticipant.setModel(tableModel);
    }
    ...
    private void initComponents() {
        ...
        tableParticipant.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                tableParticipantMouseReleased(evt);
            }
        });
        jScrollPane1.setViewportView(tableParticipant);
    ...
    private void tableParticipantMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableParticipantMouseReleased
        if (evt.getButton() == MouseEvent.BUTTON3) {
            if (SwingUtilities.isRightMouseButton(evt) && tableParticipant.getSelectedRowCount() != 0) {
                popupMenu.show(evt.getComponent(), evt.getX(), evt.getY());
            }
        }
    }//GEN-LAST:event_tableParticipantMouseReleased
    ...
    private void itemDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_itemDeleteActionPerformed
        ...
        if (selectedRow >= 0) {
            int id = (int) tableParticipant.getValueAt(selectedRow, 0);
            EntityManager entityManager = new EntityManager();
            IfaceParticipantRepository repo = new ParticipantRepository(entityManager);
            repo.deleteParticipantById(id);
    ...
    private void itemUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_itemUpdateActionPerformed
        int currentRow = tableParticipant.getSelectedRow();
        JFrame frame = new FormUpdateUI(tableParticipant.getValueAt(currentRow, 0).toString(), tableParticipant.getValueAt(currentRow, 1).toString(), tableParticipant.getValueAt(currentRow, 2).toString(), tableParticipant.getValueAt(currentRow, 3).toString());
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        // frame.getContentPane().add(mainPanel); // or whatever...
        frame.pack();
        frame.setLocationRelativeTo(null);  // *** this will center your app ***
    ...
    public javax.swing.JTable tableParticipant;
