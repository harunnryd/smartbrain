 ...
 */
public class FormUpdateUI extends JFrame {
     ...
     * Creates new form FormUI
     */
    public FormUpdateUI(String participantId, String name, String age, String address) {
        initComponents();
    ...
    private void updateButtonMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_updateButtonMousePressed
        ...
        repo.updateParticipantById(this.participantId, new Participant(nameField.getText(), Integer.parseInt(ageField.getText()), addressField.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormUpdateUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormUpdateUI().setVisible(true);
            }
        });
    }
