...
public class FormUpdateUI extends JFrame {
     ...
     * Creates new form FormUI
     */
    public FormUpdateUI(String instructorId, String name, String age) {
        initComponents();
        
        this.instructorId = Integer.parseInt(instructorId);
    ...
    private void updateButtonMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_updateButtonMousePressed
        ...
        repo.updateInstructorById(this.instructorId, new Instructor(nameField.getText(), Integer.parseInt(ageField.getText())));
