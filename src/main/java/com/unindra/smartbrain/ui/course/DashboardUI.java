 ...
 */
package com.unindra.smartbrain.ui.course;
...
public class DashboardUI extends JFrame {
    ...
    public void initTableCourse() {
        coursePageButton.setEnabled(false);
        ...
        IfaceCourseRepository repo = new CourseRepository(entityManager);
        List<Course> courses = repo.getCourses();
        
        for (Course course : courses) {
            tableModel.addRow(new Object[]{course.getId(), course.getName()});
        }
        
        tableCourse.setModel(tableModel);
    }
    ...
    private void tableCourseMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableCourseMouseReleased
        if (evt.getButton() == MouseEvent.BUTTON3) {
            if (SwingUtilities.isRightMouseButton(evt) && tableCourse.getSelectedRowCount() != 0) {
    ...
    private void itemDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_itemDeleteActionPerformed
        ...
        if (selectedRow >= 0) {
            int id = (int) tableCourse.getValueAt(selectedRow, 0);
            EntityManager entityManager = new EntityManager();
            IfaceCourseRepository repo = new CourseRepository(entityManager);
    ...
    private void itemUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_itemUpdateActionPerformed
        ...
        JFrame frame = new FormUpdateUI(tableCourse.getValueAt(currentRow, 0).toString(), tableCourse.getValueAt(currentRow, 1).toString());
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        // frame.getContentPane().add(mainPanel); // or whatever...
        frame.pack();
        frame.setLocationRelativeTo(null);  // *** this will center your app ***
